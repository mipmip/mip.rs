...
fn test_build_html_replaces_placeholders() {
    ...
    let md = "# Hello";
    let result = build_html(md, template, "abc1234", "http://localhost:8000/.temp.seed", false, "dark", false, false);
...
fn test_md_to_html_body_with_toc_with_frontmatter() {
    let md = "---\ntitle: My Doc\n---\n\n# Real Heading\n\n## Sub Heading";
    let (html, toc, _title) = md_to_html_body_with_toc(md, true, false, 1, false);
